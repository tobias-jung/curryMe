...
textstartseite.innerHTML = '<header><h2><a href="# " title="Startseite">Startseite</a></h2></header><content> Wir sind ein Unternehmen aus der Systemgastronomie und in dem Wachstumssegment Currywurst-Bringdienst tätig. In Mannheim-Neuostheim eröffneten wir im Oktober 2013 unser erstes Currywurst-Bistro mit Bringdienst.<br><br> CurryMe gehört zu den Top-Lieferdiensten in Mannheim. Probieren auch Sie es aus! So funktioniert unser Lieferservice: Lecker Curry Wurst und andere Gerichte auswählen, online bestellen und von unserem Heimservice in wenigen Minuten bis an die Haustür bringen lassen.<br><br></content><style></style>';
...
function callStartseite() {
    ...
    document.getElementById("masterContent").innerHTML = textstartseite.innerHTML;
